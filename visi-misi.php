...
<body>
  ...
  <section class="bg-pentagon py-4">
              <div class="container py-3">
                <div class="row d-flex align-items-center gy-4">
                  <div class="col-md-7">
                    <h1 class="h2 mb-0 text-uppercase">Visi Misi dan Tujuan</h1>
                  </div>
                  <div class="col-md-5">
                    <!-- Breadcrumb-->
                    <ol class="text-sm justify-content-start justify-content-lg-end mb-0 breadcrumb undefined">
                      ...
                      <li class="breadcrumb-item text-uppercase active">Visi Misi dan Tujuan</li>
                    </ol>
                  </div>
                </div>
              </div>
  ...
  <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
    ...
    <section class="py-5">
        <div class="container">
          <div class="row g-5">
            <!-- <h4>SMK PGRI 1 Bangkalan memiliki visi, misi dan tujuan sebagai berikut:</h4> -->
            <!-- PAGE CONTENT-->
            <div class="col-lg-12">
             
              <div class="row gy-4">
                <div class="col-lg-6">
                  <h5 class="text-uppercase fw-bold" style="background-color:rgb(205, 220, 253); border-radius:10px; padding:15px">VISI</h5>
                  <p style="text-align">
                  Mewujudkan SMK PGRI 1 Bangkalan sebagai SMK berstandar nasional untuk mengantarkan peserta didik menjadi manusia yang mampu dalam ilmu pengetahuan dan teknologi berdasarkan iman dan taqwa.
                </p>
              </div>
                <!-- </div>        -->
                <div class="col-lg-6"> 
                <h5 class="text-uppercase fw-bold" style="background-color:rgb(205, 220, 253); border-radius:10px; padding:15px">
                  MISI
                </h5>
                <ol>  
                <li>Melaksanakan kegiatan belajar mengajar yang berorientasi kepada pencapaian kompetensi berstandar nasional.
                </li>
                <li>
                Mengembangkan dan mengintensifkan hubungan kerjasama antar sekolah dengan dunia usaha/industri.
                </li>
                <li>
                Menerapkan atau melaksanakan sistem manajemen mutu ISO 9001:2008.
                </li>
              </ol>
                </div>
<!-- </div>    -->
                            ...
                            <div class="row">
                              ...
                              <h5 class="text-uppercase fw-bold " style="background-color:rgb(205, 220, 253); border-radius:10px; padding:15px">
                                ...
                                <p style="text-align:justify; margin-left:auto">SMK PGRI 1 Bangkalan dirancang untuk menghasilkan lulusan/tamatan yang memiliki pemahaman dan keahlian/ketrampilan serta memiliki wawasan kewirausahaan di bidang teknologi dan industri untuk mengisi kebutuhan pasar tenaga kerja. Oleh karena itu tujuan dari SMK PGRI 1 Bangkalan sebagaimana berikut: 
                                
                                <ol style="margin-left:auto">
                                  <li>Proses kegiatan pendidikan dan pelatihan kompetensi yang terencana, terorganisir, terlaksana dan terevaluasi dengan tertib dan lancar.</li>
                                  <li>Pengembangan sumber daya manusia (Guru, Staff TU, Siswa).</li>
                                  <li>Penyelenggaraam uji kompetensi secara profesional</li>
                                  <li>Pemberdayaan unit produksi secara profesional</li>
