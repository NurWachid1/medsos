  ...
  <section class="bg-pentagon py-4">
              <div class="container py-3">
                <div class="row d-flex align-items-center gy-4">
                  <div class="col-md-7">
                    <h1 class="h2 mb-0 text-uppercase">Mata Pelajaran</h1>
                  </div>
                  <div class="col-md-5">
                    <!-- Breadcrumb-->
                    <ol class="text-sm justify-content-start justify-content-lg-end mb-0 breadcrumb undefined">
                      ...
                      <li class="breadcrumb-item text-uppercase active">Mata Pelajaran</li>
                    </ol>
                  </div>
                </div>
              </div>
        ...
        <div class="container">
          <div class="row g-5">
            ...
            <div class="col-lg-12">
              ...
              <p>SMK PGRI 1 Bangkalan memiliki beberapa mata pelajaran pada setiap program keahlian yang ada seperti pada tabel berikut: 
</p>        
                      <!-- <div class="accordion-item mb-2">
                      
                        <h5 class="accordion-header" id="accordion1-headingTwo">
                          <button class="accordion-button text-uppercase fw-bold collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#accordion1-collapseTwo" aria-expanded="false" aria-controls="accordion1-collapseTwo">Data Mata Pelajaran</button>
                        </h5>
                                    ...
                                    <?php 
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													<!-- <td></td> -->
                                                    <td><?php echo $no++?></td>
													<td style="text-align:center"><?php echo $p['kodemp'] ?></td>
													<td ><?php echo $p['namamapel'] ?>
                                                </td>
                                                <?php 
											}
											?>	
