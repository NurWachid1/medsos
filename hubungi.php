...
//   if ($tambahkomen){
//     echo "<script>
//     alert('Kritik Anda Telah Terkirim!');
      ...
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" id="contactMegamenu" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Lain-Lain</a>
                  <ul class="dropdown-menu dropdown-menu-end m-0" aria-labelledby="contactMegamenu">
                    ...
                    <li><a class="dropdown-item text-uppercase border-bottom" href="hubungi.php"><i class="fa fa-whatsapp" aria-hidden="true">Hubungi Kami</i></a></li>
                  </ul>
                </li>
              </ul>
        </div>
  ...
  <section class="bg-pentagon py-4">
              <div class="container py-3">
                <div class="row d-flex align-items-center gy-4">
                  <div class="col-md-7">
                    <h1 class="h2 mb-0 text-uppercase">Hubungi Kami <i class="bi bi-whatsapp"></i></h1>
                  </div>
                  <div class="col-md-5">
                    <!-- Breadcrumb-->
                    <ol class="text-sm justify-content-start justify-content-lg-end mb-0 breadcrumb undefined">
                      ...
                      <li class="breadcrumb-item text-uppercase active">Hubungi Kami</li>
                    </ol>
                  </div>
                </div>
              </div>
          ...
          <div class="row no-gutters justify-content-center" data-aos="fade-up">
            <div class="col-lg-5 d-flex align-items-stretch">
              <div class="title" data-aos="fade-up">
                <h4 style="text-align: center">Tinggalkan Pesan Anda</h4>
