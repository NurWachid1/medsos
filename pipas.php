  ...
  <section class="bg-pentagon py-4">
              <div class="container py-3">
                <div class="row d-flex align-items-center gy-4">
                  <div class="col-md-7">
                    <h1 class="h2 mb-0 text-uppercase">Proyek IPAS</h1>
                  </div>
                  <div class="col-md-5">
                    <!-- Breadcrumb-->
                    <ol class="text-sm justify-content-start justify-content-lg-end mb-0 breadcrumb undefined">
                      ...
                      <li class="breadcrumb-item text-uppercase active">Karya P5BK</li>
                    </ol>
                  </div>
                </div>
              </div>
    ...
    <section id="katalog" class="katalog">
        <div class="container">
          ...
          <?php 
          $brgs=mysqli_query($conn,"SELECT * from pipas order by idpipas ASC");
					while($p=mysqli_fetch_array($brgs)){
            ?>
            <div class="col-lg-4 col-md-6 katalog-item filter">
              <div class="katalog-wrap">
                
                <img src="master/karya/pipas<?php echo $p['foto_pipas'] ?>" class="img-fluid" style="width: 100%"alt="P5BK">
                <div class="katalog-info">
                  <h4><?php echo $p['judulp'] ?></h4>
                  <div class="katalog-links">
                    <a href="master/karya/pipas<?php echo $p['foto_pipas'] ?>" data-gallery="katalogGallery" class="katalog-lightbox" title="<?php echo $p['judulpipas'] ?>"><i class="bx bx-images"></i></a>
                    <a href="detailpipas.php?idpipas=<?=  $p['idpipas'] ?>" title="Lihat Detail"><i class="bx bx-link"></i></a>
                  </div>
                </div>
              </div>
            </div>
