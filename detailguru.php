...
<body>
  ...
  <header class="nav-holder make-sticky" >
    <div class="navbar navbar-light bg-white fixed-top navbar-expand-lg py-0" id="navbar" >
                ...
                <div class="row d-flex align-items-center gy-4">
                  ...
                  <div class="col-md-5">
                    ...
                    <ol class="text-sm justify-content-start justify-content-lg-end mb-0 breadcrumb undefined">
                      ...
                      <li class="breadcrumb-item text-uppercase active">Guru & Tendik</li>
                    </ol>
                  </div>
                </div>
              </div>
              ...
              <div class="accordion-item mb-2">
                        ...
                        <div class="accordion-collapse collapse show" id="accordion1-collapseOne" aria-labelledby="accordion1-collapseOne" data-bs-parent="#accordion1">
                          <div class="accordion-body">
                            ...
                            <div class="row">
                              <div class="col-md-4"><img class="img-fluid" src=" guru/<?php echo $data['foto'] ?>" alt="Kereta Meriam">
                              </div>
                              <div class="col-md-8">
