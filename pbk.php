  ...
  <section class="bg-pentagon py-4">
              <div class="container py-3">
                <div class="row d-flex align-items-center gy-4">
                  <div class="col-md-7">
                    <h1 class="h2 mb-0 text-uppercase">Karya P5BK</h1>
                  </div>
                  <div class="col-md-5">
                    <!-- Breadcrumb-->
    ...
    <section id="katalog" class="katalog">
        <div class="container">
          ...
          <?php 
          $brgs=mysqli_query($conn,"SELECT * from p5bk order by idp5bk ASC");
					while($p=mysqli_fetch_array($brgs)){
            ?>
            <div class="col-lg-4 col-md-6 katalog-item filter">
              <div class="katalog-wrap">
                
                <img src="master/karya/p5bk<?php echo $p['fotop'] ?>" class="img-fluid" style="width: 100%"alt="P5BK">
                <div class="katalog-info">
                  <h4><?php echo $p['judulp'] ?></h4>
                  <div class="katalog-links">
                    <a href="master/karya/p5bk<?php echo $p['fotop'] ?>" data-gallery="katalogGallery" class="katalog-lightbox" title="<?php echo $p['judulp'] ?>"><i class="bx bx-images"></i></a>
                    <a href="detailpbk.php?idp5bk=<?=  $p['idp5bk'] ?>" title="Lihat Detail"><i class="bx bx-link"></i></a>
                  </div>
                </div>
              </div>
            </div>
