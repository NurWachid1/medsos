  ...
  <section class="bg-pentagon py-4">
              <div class="container py-3">
                <div class="row d-flex align-items-center gy-4">
                  <div class="col-md-7">
                    <h1 class="h2 mb-0 text-uppercase">Sejarah</h1>
                  </div>
                  <div class="col-md-5">
                    <!-- Breadcrumb-->
                    <ol class="text-sm justify-content-start justify-content-lg-end mb-0 breadcrumb undefined">
                      <li class="breadcrumb-item"><a class="text-uppercase" href="index.php#profil">Profil</a></li>
                      <li class="breadcrumb-item text-uppercase active">Sejarah</li>
                    </ol>
                  </div>
                </div>
              </div>
              ...
              <!-- <div class="accordion mb-5" id="accordion1">
                      ...
                      <div class="accordion-item mb-2">
                        <h5 class="accordion-header" id="accordion1-headingTwo">
                          <button class="accordion-button text-uppercase fw-bold collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#accordion1-collapseTwo" aria-expanded="false" aria-controls="accordion1-collapseTwo">Sejarah Singkat</button>
                        </h5>
                        <div class="accordion-collapse collapse" id="accordion1-collapseTwo" aria-labelledby="accordion1-collapseTwo" data-bs-parent="#accordion1">
                          <div class="accordion-body"> -->
                            <div class="row">
                              <div class="col-md-4"><img class="img-fluid" src="vendor/images/logo-pgri.png" alt="SMK PGRI 1 Bangkalan">
                            </div>
                              <div class="col-md-8">
                              <p style="text-align: justify; text-indent: 50px">
                              SMK PGRI 1 Bangkalan merupakan SMK tertua yang ada di Bangkalan dengan perjalanan sejarah yang cukup panjang. Pada awalnya SMK PGRI 1 Bangkalan menempati sekolah milik Sekolah Teknik (ST) yang sederajat dengan SMP. Dengan sistem sekolah bergantian, ST masuk pagi dan SMK masuk siang. Saat itu SMK PGRI 1 Bangkalan masih bernama STM PGRI 1 Bangkalan. STM merupakan singkatan dari Sekolah Teknik Mesin, karena pada saat itu hanya terdapat jurusan teknik mesin. STM ini menjadi sekolah favorit yang banyak diminati oleh peserta didik dari berbagai daerah, karena tidak ada sekolah kejuruan mesin yang ada di Bangkalan pada masa itu. Seiring berjalannya waktu, terdapat peraturan pemerintah yang mewajibkan bahwa sekolah kejuruan harus berubah nama menjadi SMK atau Sekolah Menengah Kejuruan. Dengan adanya peraturan pemerintah tersebut, maka STM PGRI 1 Bangkalan resmi diubah menjadi SMK PGRI 1 Bangkalan hingga saat ini.
            </p>
                              </div>
                        <!-- </div>
                      </div>
