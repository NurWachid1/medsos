...
<body>
  ...
  <section class="bg-pentagon py-4">
              <div class="container py-3">
                <div class="row d-flex align-items-center gy-4">
                  <div class="col-md-7">
                    <h1 class="h2 mb-0 text-uppercase">Struktur Organisasi</h1>
                  </div>
                  <div class="col-md-5">
                    <!-- Breadcrumb-->
                    <ol class="text-sm justify-content-start justify-content-lg-end mb-0 breadcrumb undefined">
                      ...
                      <li class="breadcrumb-item text-uppercase active">Struktur Organisasi</li>
                    </ol>
                  </div>
                </div>
              </div>
  ...
  <path d="M8 16s6-5.686 6-10A6 6 0 0 0 2 6c0 4.314 6 10 6 10zm0-7a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
          ...
          <div class="row no-gutters justify-content-center" data-aos="fade-up">
            <div class="col-lg-5 d-flex align-items-stretch">
              <div class="title" data-aos="fade-up">
                <h3 style="text-align: center;" class="text-uppercase mb-3">Struktur Organisasi</h3>
                <h4 style="text-align: center; padding-bottom:30px" class="text-uppercase mb-3">SMK PGRI 1 Bangkalan</h4>
                <img src="../vendor/assets/img/struktur.png" style="width: 100%">
              </div>
            </div>
    ...
    <!-- <img style="width:100%;margin-left: auto; margin-right: auto; display: block" src="vendor/assets/img/struktur.png">
                                <h3 style="text-align:center">Struktur Organisasi SMK PGRI 1 Bangkalan</h3> -->
