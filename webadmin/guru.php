...
<body>
  ...
  <section class="bg-pentagon py-4">
        ...
        $brgs=mysqli_query($conn,"SELECT * from guru order by idguru ASC");
            ...
            ?>
        <div class="col-lg-3 col-md-3 col-sm-6 text-center"><a href="detail2.php"><img class="avatar avatar-xl p-1 mb-4" src="../guru/<?php echo $p['foto'] ?>" alt="Han Solo"></a>
              <h4 class="h4 mb-1 "><a class="text-reset" href="detail2.php?idguru=<?= $p['idguru']; ?>"><?php echo $p['namaguru'] ?></a></h4>
