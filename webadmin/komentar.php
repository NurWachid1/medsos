...
if(isset($_POST["addkomen"])) {
  ...
  if ($tambahkomen){
  echo "
  <meta http-equiv='refresh' content='20; url= komentar.php'/>  ";
  } else { echo "
   <meta http-equiv='refresh' content='20; url= komentar.php'/> ";
  }
};
  ...
  <section class="bg-pentagon py-4">
              <div class="container py-3">
                <div class="row d-flex align-items-center gy-4">
                  <div class="col-md-7">
                    <h1 class="h2 mb-0 text-uppercase">Komentar & Saran</h1>
                  </div>
                  <div class="col-md-5">
                    <!-- Breadcrumb-->
                    <ol class="text-sm justify-content-start justify-content-lg-end mb-0 breadcrumb undefined">
                      ...
                      <li class="breadcrumb-item text-uppercase active">Komentar</li>
                    </ol>
                  </div>
                </div>
              </div>
