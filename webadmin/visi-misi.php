                  ...
                  <div class="accordion mb-5" id="accordion2">
                          <div class="accordion-item mb-2">
                            <h5 class="accordion-header" id="accordion2-headingOne">
                              <button class="accordion-button text-uppercase fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#accordion2-collapseOne" aria-expanded="true" aria-controls="accordion2-collapseOne">VISI</button>
                            </h5>
                            <div class="accordion-collapse collapse show" id="accordion2-collapseOne" aria-labelledby="accordion2-collapseOne" data-bs-parent="#accordion2">
                              <div class="accordion-body">
                                <p style="text-align">Terwujudnya peserta didik yang maju dalam IPTEK berdasarkan IMTAQ (Iman dan Taqwa)</p></div>
                            </div>
                          </div>
                          </div>
                </div>
                  ...
                  <div class="accordion mb-5" id="accordion3">
                          <div class="accordion-item mb-2">
                            <h5 class="accordion-header" id="accordion3-headingOne">
                              <button class="accordion-button text-uppercase fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#accordion3-collapseOne" aria-expanded="true" aria-controls="accordion3-collapseOne">MISI</button>
                            </h5>
                            <div class="accordion-collapse collapse show" id="accordion3-collapseOne" aria-labelledby="accordion3-collapseOne" data-bs-parent="#accordion3">
                              <div class="accordion-body"><ol style="text-align:justify">
                <li>Terwujudnya peserta didik SMK PGRI 1 Bangkalan berbudi pekerti dan berakhlak pada setiap pelajaran.
                </li>
                <li>
                Terwujudnya peningkatan kompetensi siswa dalam menghadapi IPTEK secara global.
                </li>
                <li>
                Tercapainya tamatan yang kreatif, produktif dan mampu mengembangkan diri dalam lingkungan masyarakat.
                </li>
              </ol></div>
                            </div>
                          </div>
