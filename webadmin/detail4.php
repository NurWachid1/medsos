...
$sql = "SELECT*from ekskul where idekskul='$idekskul'";
  ...
  <section class="bg-pentagon py-4">
              <div class="container py-3">
                <div class="row d-flex align-items-center gy-4">
                  <div class="col-md-7">
                    <h1 class="h2 mb-0 text-uppercase"><?php echo $data['namaekskul'] ?></h1>
                  </div>
                  <div class="col-md-5">
                    <!-- Breadcrumb-->
            ...
            <div class="col-lg-12">
              ...
              <div class="accordion-item mb-2">
                        <h5 class="accordion-header" id="accordion1-headingOne">
                          <button class="accordion-button text-uppercase fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#accordion1-collapseOne" aria-expanded="true" aria-controls="accordion1-collapseOne">Data Ekstrakurikuler</button>
                        </h5>
                        <div class="accordion-collapse collapse show" id="accordion1-collapseOne" aria-labelledby="accordion1-collapseOne" data-bs-parent="#accordion1">
                          <div class="accordion-body">
                            ...
                            <div class="row">
                              <div class="col-md-4"><img class="img-fluid" src=" ekskul/<?php echo $data['foto'] ?>" alt="Foto Ekskul">
                              </div>
                              <div class="col-md-8">
                                <br>Nama Ekstrakurikuler  : <?php echo $data['namaekskul'] ?>
                                <br>Deskripsi              : <?php echo $data['deskripsie'] ?>
                              </p>  
                            </div>
                            </div>
                          </div>
                      ...
                      <a href="ekskul.php" class="btn btn-primary btn-sm my-1 detaildata" ><i class="fas fa-arrow-left" aria-hidden="true"></i> Kembali</a>
                      <?php } }else {
