  ...
  <section class="bg-pentagon py-4">
              <div class="container py-3">
                <div class="row d-flex align-items-center gy-4">
                  <div class="col-md-7">
                    <h1 class="h2 mb-0 text-uppercase">Fasilitas</h1>
                  </div>
                  <div class="col-md-5">
                    <!-- Breadcrumb-->
                    <ol class="text-sm justify-content-start justify-content-lg-end mb-0 breadcrumb undefined">
                      <li class="breadcrumb-item"><a class="text-uppercase" href="index.php#hero">Profil</a></li>
              ...
              <div class="katalog-wrap">
                ...
                <div class="katalog-info">
                  ...
                  <div class="katalog-links">
                    ...
                    <!-- <a href="detailfasilitas.php?idfasilitas=<?=  $p['idfasilitas'] ?>" title="Lihat Detail"><i class="bx bx-link"></i></a> -->
                  </div>
                </div>
              </div>
            </div>
