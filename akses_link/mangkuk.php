...
<section id="profil" class="profil">
    ...
    <div class="row">
     <section>
      <h2 style="text-align: center"><strong>Piring</strong></h2>
</section>
        <div class="col-xl-6 col-lg-7" >
            <h3 >Data Benda</h3>
            <p >No Inventaris       : 54/BKL/2008
            <br>Ineventaris Museum  : 428/00
            <br>Kategori            : Perabotan
            <br>Lokasi Asal         : Aermata Ibu, Arosbaya
            <br>Bahan               : Keramik
            <br>Ukuran              : Tg 1,8 cm; Tb bibir 0,2 cm; Lubang Atas 13,5 cm
          </p>
        </div>
        <div class="col-xl-6 col-lg-5 pt-5 pt-lg-0">
            <img src="../file/mangkuk.png" class="img-fluid" alt="Mangkuk">
        </div> 
    </div>
    <section>
          <h3 style="text-align: center">Deskripsi</h3>
          <p style="text-align: justify; text-indent: 50px"> Merupakan wadah terbuka berbentuk setengah bola, bibir terbuka, dinding luar berhias geometris bervariasi dengan tulisan huruf Cina, bagian dinding dalam warna putih dan terdapat lingkaran berwarna biru yang di dalamnya terdapat hiasan seekor seekor binatang dengan teknik stiliran, sedang bagian dasar kaki berbentuk bulat menonjol, mangkuk berglasir warna biru, kondisi utuh.</p>
            </section>
</div>
</section>
