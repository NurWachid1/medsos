     ...
     <section>
      <h2 style="text-align: center"><strong>Piring</strong></h2>
        ...
        <div class="col-xl-6 col-lg-5 pt-5 pt-lg-0">
            <img src="../file/piring.png" class="img-fluid" alt="Mangkuk">
        </div> 
    </div>
    <section>
          <h3 style="text-align: center">Deskripsi</h3>
          <p style="text-align: justify; text-indent: 50px"> Sebuah wadah terbuka dengan bentuk lingkaran dan tidak berkaki. Dinding melebar keluar bibir terbuka. Bagian dalam berwarna biru pada bagian bibir dengan hiasan spiral melingkari bibir, pada dasar berhias flora dan pemandangan dengan warna biru. Kondisi benda baik dan utuh.</p>
            </section>
</div>
</section>
