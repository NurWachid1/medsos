...
<section id="profil" class="profil">
    ...
    <div class="row">
     <section>
      <h2 style="text-align: center"><strong>Tandu Permaisuri</strong></h2>
</section>
        <div class="col-xl-6 col-lg-7" >
            <h3 >Data Benda</h3>
            <p >No Inventaris       : 216/BKL/2008
            <br>Ineventaris Museum  : 412/00
            <br>Kategori            : Lainnya
            <br>Lokasi Asal         : Aermata Ibu, Arosbaya
            <br>Bahan               : Kayu
            <br>Ukuran              : P 157 cm, L 98 cm, Tg 154 cm
          </p>
        </div>
        <div class="col-xl-6 col-lg-5 pt-5 pt-lg-0">
            <img src="../file/tandu_permaisuri.png" class="img-fluid" alt="Tandu Permaisuri">
        </div> 
    </div>
    <section>
          <h3 style="text-align: center">Deskripsi</h3>
          <p style="text-align: justify; text-indent: 50px">Bentuk segi empat, dinding terbuka dengan atap limasan. Terdiri atas tiga bagian; kaki, tubuh, dan atap. Kaki polos setinggi 16 cm. Pada bagian kaki ini terdapat kolong besi yang digunakan sebagai tempat untuk meletakkan bambu pengusung. Bagian tubuh berpagar langkan setinggi 21 cm dengan hiasan berupa ukiran motif flora, demikian juga keempat tiang penyangga atap. Pada salah satu sisi, pagar langkan cuma dibuat separuh bagian, yang fungsinya untuk tempat keluar masuk tandu. Bagian atap ini kemungkinan hasil penggantian dengan bahan baru. Tandu ini di at dengan warna hijau dan hiasan motif warna emas (sudah pudar).</p>
            </section>
</div>
</section>
