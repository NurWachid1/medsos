...
<section id="profil" class="profil">
    ...
    <div class="row">
     <section>
      <h2 style="text-align: center"><strong>Mata Uang Belanda</strong></h2>
</section>
        <div class="col-xl-6 col-lg-7" >
            <h3 >Data Benda</h3>
            <p >No Inventaris       : 179/BKL/2008
            <br>Ineventaris Museum  : -
            <br>Kategori            : Perabotan
            <br>Lokasi Asal         : Aermata Ibu, Arosbaya
            <br>Bahan               : Logam/Tembaga
            <br>Ukuran              : Diameter 2,8 cm; Tebal 0,1 cm
          </p>
        </div>
        <div class="col-xl-6 col-lg-5 pt-5 pt-lg-0">
            <img src="../file/mata_uang_belanda.png" class="img-fluid" alt="Mangkuk">
        </div> 
    </div>
    <section>
          <h3 style="text-align: center">Deskripsi</h3>
          <p style="text-align: justify; text-indent: 50px">Bentuk lingkaran pipih. Sisi depan bergambar lambang kerajaan Belanda (seekor singa membawa pedang dan mahkota di atasanya). Pada sisi ini juga terapat nilai nominal mata uang, yaitu 1/2 S. Sisi belakang terdapat tulisan INDIA BATAV serta angka tahun.</p>
            </section>
</div>
</section>
