...
<section id="profil" class="profil">
    ...
    <div class="row">
     <section>
      <h2 style="text-align: center"><strong>Peluru Meriam</strong></h2>
</section>
        <div class="col-xl-6 col-lg-7" >
            <h3 >Data Benda</h3>
            <p >No Inventaris       : 190/BKL/2008 - 215/BKL/2008
            <br>Ineventaris Museum  : 300/00 - 326/00
            <br>Kategori            : Senjata
            <br>Lokasi Asal         : Aermata Ibu, Arosbaya
            <br>Bahan               : Besi
            <br>Ukuran              : Diameter 12 cm
          </p>
        </div>
        <div class="col-xl-6 col-lg-5 pt-5 pt-lg-0">
            <img src="../file/peluru_meriam.png" class="img-fluid" alt="Peluru Meriam">
        </div> 
    </div>
    <section>
          <h3 style="text-align: center">Deskripsi</h3>
          <p style="text-align: justify; text-indent: 50px">Berbentuk bulat dengan tekstur halus. Warna abu-abu kecoklatan. Kondisi baik.</p>
            </section>
</div>
</section>
