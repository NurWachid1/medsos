...
<section id="profil" class="profil">
    ...
    <div class="row">
     <section>
      <h2 style="text-align: center"><strong>Lonceng Cincin</strong></h2>
</section>
        <div class="col-xl-6 col-lg-7" >
            <h3 >Data Benda</h3>
            <p >No Inventaris       : 218/BKL/2008
            <br>Ineventaris Museum  : 432/00
            <br>Kategori            : Lainnya
            <br>Lokasi Asal         : Aermata Ibu, Arosbaya
            <br>Bahan               : Logam
            <br>Ukuran              : Diameter atas 17 cm, bawah 32,5 cm, Tg 33,5 cm, Tebal 1,7 cm
          </p>
        </div>
        <div class="col-xl-6 col-lg-5 pt-5 pt-lg-0">
            <img src="../file/lonceng_cincin.png" class="img-fluid" alt="Lonceng Cincin">
        </div> 
    </div>
    <section>
          <h3 style="text-align: center">Deskripsi</h3>
          <p style="text-align: justify; text-indent: 50px">Bentuk silindrik, bagian ujung melebar, tempat gantungan (atas) berbentuk piramida dengan lubang segi empat. Lonceng ini polos, hiasan berupa pelipit-pelipit melingkar lonceng. Anak lonceng terbuat dari logam. Ujungnya membulat dan bagian bawah mempunyai cincin besi dengan sebagai tempat tali untuk menarik anak lonceng.</p>
            </section>
</div>
</section>
