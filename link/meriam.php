...
<section id="profil" class="profil">
    ...
    <div class="row">
     <section>
      <h2 style="text-align: center"><strong>Meriam</strong></h2>
</section>
        <div class="col-xl-6 col-lg-7">
            <h3 >Data Benda</h3>
            <p >No Inventaris       : 182/BKL/2008
            <br>Ineventaris Museum  : 298/00
            <br>Kategori            : Senjata
            <br>Lokasi Asal         : Aermata Ibu, Arosbaya
            <br>Bahan               : Perunggu
            <br>Ukuran              : P 126 cm, Lubang Pangkal 19 cm, Lubang Ujung 14 cm
          </p>
        </div>
        <div class="col-xl-6 col-lg-5 pt-5 pt-lg-0">
            <img src="../file/meriam.png" class="img-fluid" alt="Meriam">
        </div> 
    </div>
    <section>
          <h3 style="text-align: center">Deskripsi</h3>
          <p style="text-align: justify; text-indent: 50px"> Bentuk silindris/tabung, bagian ujung lebih kecil daripada bagian pangkal. Tubuh meriam dihias dengan pelipit-pelipit/cincin belah rotan. Di pelipit bagian pangkal terdapat pahatan angka/register 987 dan di bagian depan terdapat tulisan L. BORCH HARG : ENCHUYSEN 1767. Di depan tulisan terdapat lubang tempat sumbu dalam bingkai segi empat. Di bagian tengah meriam terdapat pasak (untuk melekatkan meriam pada kereta meriam). Bentuk pasak ini silinder, dengan panjang 5,5 cm.</p>
            </section>
</div>
</section>
