...
<section id="profil" class="profil">
    ...
    <div class="row">
     <section>
      <h2 style="text-align: center"><strong>Lonceng</strong></h2>
</section>
        <div class="col-xl-6 col-lg-7" >
            <h3 >Data Benda</h3>
            <p >No Inventaris       : 217/BKL/2008
            <br>Ineventaris Museum  : 412/00
            <br>Kategori            : Lainnya
            <br>Lokasi Asal         : Aermata Ibu, Arosbaya
            <br>Bahan               : Logam
            <br>Ukuran              : Diameter atas 23 cm, bawah 49 cm, Tg 51,5 cm, Tebal 2 cm
          </p>
        </div>
        <div class="col-xl-6 col-lg-5 pt-5 pt-lg-0">
            <img src="../file/lonceng.png" class="img-fluid" alt="Tandu Permaisuri">
        </div> 
    </div>
    <section>
          <h3 style="text-align: center">Deskripsi</h3>
          <p style="text-align: justify; text-indent: 50px">Bentuk silindrik, bagian ujung melebar, tempat gantungan (atas) berbentuk piramida dengan lubang segi empat. Pada bagian bahu genta dihias dengan hiasan geometris (seperti kelopak Padma), dan di bawah bahu genta terdapat tulisan IENIE LONTJENG KANDJENG PANEMBAHAN POENJA 1870. Kondisi lonceng utuh, bagian bibir hingga bagian tengah terdapat keretakan.</p>
            </section>
</div>
</section>
