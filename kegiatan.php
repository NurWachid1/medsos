  ...
  <section class="bg-pentagon py-4">
              <div class="container py-3">
                <div class="row d-flex align-items-center gy-4">
                  <div class="col-md-7">
                    <h1 class="h2 mb-0 text-uppercase">Kegiatan</h1>
                  </div>
                  <div class="col-md-5">
                    <!-- Breadcrumb-->
          ...
          $brgs=mysqli_query($conn,"SELECT * from kegiatan order by idkegiatan ASC");
            ...
            <div class="col-lg-4 col-md-6 katalog-item filter">
              <div class="katalog-wrap">
                ...
                <img src="kegiatan/<?php echo $p['foto'] ?>" class="img-fluid" style="width: 100%"alt="">
                <div class="katalog-info">
                  <h4><?php echo $p['namakegiatan'] ?></h4>
                  <div class="katalog-links">
                    <!-- <a href="kegiatan/<?php echo $p['foto'] ?>" data-gallery="katalogGallery" class="katalog-lightbox" title="<?php echo $p['namakegiatan'] ?>"><i class="bx bx-plus"></i></a> -->
                    <a href="detailkegiatan.php?idkegiatan=<?=  $p['idkegiatan'] ?>" title="Lihat Detail"><i class="bx bx-link"></i></a>
                  </div>
                </div>
              </div>
            </div>
