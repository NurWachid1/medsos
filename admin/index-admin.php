...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <h1><img src="../vendor/images/cakra1.png" class="animated-logo" alt="" height="50" width="48"><a href="index-admin.php"  >MUSEUM CAKRANINGRAT</a></h1>
      </div>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container text-center text-md-left" data-aos="fade-ups">
      <h1 class="text-center">Si Ningrat</h1>
      <h2>Si Ningrat merupakan sistem informasi berbasis website yang berisi atas seluruh informasi dari Museum Cakraningrat.</h2>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box icon-box-cyan">
              ...
              <p class="description">Visi misi pada museum ini adalah<span id="dots">...</span><span id="more"></span></p>
          ...
          $brgs=mysqli_query($conn,"SELECT * from kategori k, katalog p where k.idkategori=p.idkategori order by idkatalog ASC");
            ...
            ?>
              <ul id="katalog-flters">
                ...
                <li data-filter=".filter-<?php echo $p['nama_kategori'] ?>"><?php echo $p['nama_kategori'] ?></li>
              </ul>
            </div>
          </div>
