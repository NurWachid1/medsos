...
// require 'function.php';
	...
	if(isset($_POST['addprestasi']))
	{
		...
		$tambahpres = mysqli_query($conn,"insert into prestasi values ('','$prestasi','$nama','$tahun')");
		if ($tambahpres){
		echo "<script>
...
<head>
    ...
    <title>Data Prestasi | SMK PGRI 1 Bangkalan</title>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row my-2">
                                    <div class="col-md">
                                    <button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-primary">Tambah Prestasi</button>
                                    </div>
                                </div>
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													...
													<td style="text-align:center">
                                                        ...
                                                        <a href="ubahprestasi.php?idprestasi=<?= $p['idprestasi']; ?>" class="btn btn-warning btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;Ubah</a> |
                                                        <a href="hapusprestasi.php?idprestasi=<?= $p['idprestasi']; ?>" class="btn btn-danger btn-sm" style="font-weight: 600;" onclick="return confirm('Apakah anda yakin ingin menghapus Prestasi dari hari <?= $row['nama']; ?> ?');"><i class="bi bi-trash-fill"></i>&nbsp;Hapus</a>
                                                    </td>
												<?php 
											}
											?>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Masukkan Prestasi</h4>
						</div>
					<div class="modal-body">
						<form action="prestasi.php" method="post">
								<div class="form-group">
									<label>Prestasi<span style="color: red">*</span></label>
									<input name="prestasi" type="text" class="form-control" placeholder="Masukkan Prestasi" required>
								</div>
								<div class="form-group">
									<label>Nama<span style="color: red">*</span></label>
									<input name="nama" type="text" class="form-control" placeholder="Nama Pemberi Prestasi" required>
								</div>
                                <div class="form-group">
									<label>Tahun Prestasi<span style="color: red">*</span></label>
									<input name="tahun" type="text" class="form-control" placeholder="Tahun Prestasi" required>
								</div>

							<div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
								<input name="addprestasi" type="submit" class="btn btn-primary" value="Tambah">
							</div>
						</form>
					</div>
				</div>
