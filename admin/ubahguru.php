...
$guru = query("SELECT * FROM `guru` WHERE `idguru` = '$idguru'")[0];
        ...
        <div class="row my-2">
            <div class="col-md">
                ...
                <input type="hidden" name="gambarLama" value="<?= $guru['foto']; ?>">
                    <div class="mb-3">
                        <label for="idguru" class="form-label">ID GURU<span style="color: red">*</span></label>
                        <input type="number" class="form-control w-50" id="idguru" value="<?= $guru['idguru']; ?>" name="idguru" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="gambar" class="form-label">Foto Guru <i>(Saat ini)</i><span style="color: red">*</span></label> <br>
                        <img src="../guru/<?= $guru['foto']; ?>" width="20%" style="margin-bottom: 10px;">
                        <input class="form-control form-control-sm w-50" id="gambar" name="gambar" type="file">
                        <p style="font-size: 12px"><b>File yang Diterima:</b> jpg, png maks. 4MB</p>
                    </div>
                    <div class="mb-3">
                        <label for="nip" class="form-label">NIP</label>
                        <input type="text" class="form-control w-50" id="nip" value="<?= $guru['nip']; ?>" name="nip" autocomplete="off" >
                    </div>
                    <div class="mb-3">
                        <label for="namaguru" class="form-label">Nama Guru<span style="color: red">*</span></label>
                        <input type="text" class="form-control w-50" id="namaguru" value="<?= $guru['namaguru']; ?>" name="namaguru" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="keterangan" class="form-label">Jabatan<span style="color: red">*</span></label>
                        <input type="text" class="form-control w-50" id="keterangan" value="<?= $guru['keterangan']; ?>" name="keterangan" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="alamat" class="form-label">Alamat Guru<span style="color: red">*</span></label>
                        <input type="text" class="form-control w-50" id="alamat" value="<?= $guru['alamat']; ?>" name="alamat" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="pendidikanterakhir" class="form-label">Pendidikan Terakhir<span style="color: red">*</span></label>
                        <input type="text" class="form-control w-50" id="pendidikanterakhir" value="<?= $guru['pendidikanterakhir']; ?>" name="pendidikanterakhir" autocomplete="off" required>
                    </div>
                    
                    <hr>
                    <a href="guru.php" class="btn btn-secondary">Kembali</a>
                    <button type="submit" class="btn btn-warning" name="ubahguru">Ubah</button>
                </form>
            </div>
        </div>
    </div>
