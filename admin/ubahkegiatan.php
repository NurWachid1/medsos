...
$kegiatan = query("SELECT * FROM kegiatan WHERE idkegiatan = $idkegiatan")[0];
...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="fw-bold text-uppercase"><i class="bi bi-pencil-square"></i>&nbsp;Ubah Data kegiatan</h3>
            </div>
            <hr>
        </div>
        <div class="row my-2">
            <div class="col-md">
                ...
                <input type="hidden" name="gambarLama" value="<?= $kegiatan['foto']; ?>">
                    <div class="mb-3">
                        <label for="idkaegiatan" class="form-label">ID KEGIATAN<span style="color: red">*</span></label>
                        <input type="number" class="form-control w-50" id="idkegiatan" value="<?= $kegiatan['idkegiatan']; ?>" name="idkegiatan" readonly>
                    </div>
                    
                    <div class="mb-3">
                        <label for="foto" class="form-label">Gambar Kegiatan <i>(Saat ini)</i><span style="color: red">*</span></label> <br>
                        <img src="../kegiatan/<?= $kegiatan['foto']; ?>" width="20%" style="margin-bottom: 10px;">
                    ...
                    <div class="mb-3">
                        <label for="namakegiatan" class="form-label">Kegiatan<span style="color: red">*</span></label>
                        <input type="text" class="form-control w-50" id="namakegiatan" value="<?= $kegiatan['namakegiatan']; ?>" name="namakegiatan" autocomplete="off" required>
                    </div>
                    
                    <div class="mb-3">
                        <label for="deskripsik" class="form-label">Deskripsi<span style="color: red">*</span></label>
                        <input type="text" class="form-control w-50"  id="deskripsik" value="<?= $kegiatan['deskripsik']; ?>" name="deskripsik" autocomplete="off" required>
                    </div>
                    <hr>
                    <a href="kegiatan.php" class="btn btn-secondary">Kembali</a>
                    <button type="submit" class="btn btn-warning" name="ubahkegiatan">Ubah</button>
                </form>
            </div>
        </div>
    </div>
