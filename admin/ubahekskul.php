...
<body>
                        ...
                        <li><a href="admin.php"><i class="ti-user"></i><span>Data Admin</span></a></li>
							...
							<li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li class="active"><a href="mapel.php">Mata Pelajaran</a></li>
                                </ul>
                            </li>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="fw-bold text-uppercase"><i class="bi bi-pencil-square"></i>&nbsp;Ubah Data Ekstrakurikuler</h3>
            </div>
            <hr>
        </div>
        <div class="row my-2">
            <div class="col-md">
                ...
                <input type="hidden" name="gambarLama" value="<?= $ekskul['foto']; ?>">
                    <div class="mb-3">
                        <label for="idekskul" class="form-label">ID EKSTRAKULIKULER<span style="color: red">*</span></label>
                        <input type="number" class="form-control w-50" id="idekskul" value="<?= $ekskul['idekskul']; ?>" name="idekskul" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="namaekskul" class="form-label">Ekstrakulikulier<span style="color: red">*</span></label>
                        <input type="text" class="form-control w-50" id="namaekskul" value="<?= $ekskul['namaekskul']; ?>" name="namaekskul" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="foto" class="form-label">Gambar <i>(Saat ini)</i><span style="color: red">*</span></label> <br>
                        <img src="../ekskul/<?= $ekskul['foto']; ?>" width="20%" style="margin-bottom: 10px;">
                    ...
                    <div class="mb-3">
                        <label for="deskripsie" class="form-label">Deskripsi<span style="color: red">*</span></label>
                        <input type="text" class="form-control w-50"  id="deskripsie" value="<?= $ekskul['deskripsie']; ?>" name="deskripsie" autocomplete="off" required>
                    </div>
                    
                    <hr>
                    <a href="ekskul.php" class="btn btn-secondary">Kembali</a>
                    <button type="submit" class="btn btn-warning" name="ubahekskul">Ubah</button>
                </form>
            </div>
        </div>
    </div>
