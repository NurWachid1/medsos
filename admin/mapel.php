...
// require 'function.php';
	...
	if(isset($_POST['addmapel']))
	{
		...
		$tambahmp = mysqli_query($conn,"insert into mapel values ('','$kodemp','$mapel')");
		if ($tambahmp){
		echo "<script>
        ...
        document.location.href = 'mapel.php';
            ...
            alert('Data Mata Pelajaran Gagal Ditambahkan!');
        </script>";
		}
...
<head>
    ...
    <title>Data Mata Pelajaran | SMK PGRI 1 Bangkalan</title>
            ...
            <div class="main-menu">
                ...
                <nav>
                        ...
                        <li><a href="admin.php"><i class="ti-user"></i><span>Data Admin</span></a></li>
							...
							<!-- <li><a href="user.php"><span>Data Admin</span></a></li> -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row my-2">
                                    <div class="col-md">
                                    <button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-primary">Tambah Mapel</button>
                                    </div>
                                </div>
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from mapel order by idmapel ASC");
											$no=1;
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													<!-- <td></td> -->
                                                    <td><?php echo $no++?></td>
													<td><?php echo $p['kodemp'] ?></td>
													<td><?php echo $p['namamapel'] ?></td>
													<td style="text-align:center">
                                                        ...
                                                        <a href="ubahmapel.php?idmapel=<?= $p['idmapel']; ?>" class="btn btn-warning btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;Ubah</a> |
                                                        <a href="hapusmapel.php?idmapel=<?= $p['idmapel']; ?>" class="btn btn-danger btn-sm" style="font-weight: 600;" onclick="return confirm('Apakah anda yakin ingin menghapus Mata Pelajaran dari hari <?= $row['namamapel']; ?> ?');"><i class="bi bi-trash-fill"></i>&nbsp;Hapus</a>
                                                    </td>
												<?php 
											}
											?>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Masukkan Data Mata Pelajaran</h4>
						</div>
					<div class="modal-body">
						<form action="mapel.php" method="post">
								<div class="form-group">
									<label>Kode Mata Pelajaran<span style="color: red">*</span></label>
									<input name="kodemp" type="text" class="form-control" placeholder="Masukkan Kode Mapel" required>
								</div>
								<div class="form-group">
									<label>Mata Pelajaran<span style="color: red">*</span></label>
									<input name="namamapel" type="text" class="form-control" placeholder="Masukkan Mapel" required>
								</div>

							<div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
								<input name="addmapel" type="submit" class="btn btn-primary" value="Tambah">
							</div>
						</form>
					</div>
				</div>
