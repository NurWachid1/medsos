...
<head>
    ...
    <title>Data Admin | SMK PGRI 1 Bangkalan</title>
...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="fw-bold text-uppercase"><i class="bi bi-pencil-square"></i>&nbsp;Ubah Data Admin</h3>
            </div>
            <hr>
        </div>
        <div class="row my-2">
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="idadmin" class="form-label">ID ADMIN<span style="color: red">*</span></label>
                        <input type="number" class="form-control w-50" id="idadmin" value="<?= $admin['idadmin']; ?>" name="idadmin" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="username" class="form-label"><i>Username</i><span style="color: red">*</span></label>
                        <input type="text" minlength="3" maxlength="20" class="form-control w-50" id="username" value="<?= $admin['username']; ?>" name="username" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="password" class="form-label">Kata Sandi<span style="color: red">*</span></label>
                        <input type="text" minlength="3" maxlength="10" class="form-control w-50" id="password" value="<?= $admin['password']; ?>" name="password" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="namaadmin" class="form-label">Nama Admin<span style="color: red">*</span></label>
                        <input type="text" class="form-control w-50" id="namaadmin" value="<?= $admin['namaadmin']; ?>" name="namaadmin" autocomplete="off" required>
                    </div>
                    
                    <hr>
                    <a href="admin.php" class="btn btn-secondary">Kembali</a>
                    <button type="submit" class="btn btn-warning" name="ubahadmin">Ubah</button>
                </form>
            </div>
        </div>
    </div>
