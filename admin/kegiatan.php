...
$deskripsi=$_POST['deskripsik'];
		...
		$ekstensi_diperbolehkan	= array('png','jpg');
			...
			if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
				if($ukuran < 1944070){			
					move_uploaded_file($file_tmp, '../kegiatan/'.$nama);
					$query = "insert into kegiatan (`namakegiatan`,`foto`,`deskripsik`) values('$kegiatan','$nama','$deskripsi')";
...
<head>
    ...
    <title>Data Kegiatan | SMK PGRI 1 Bangkalan</title>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row my-2">
                                    <div class="col-md">
                                    <button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-primary">Tambah Kegiatan</button>
                                    </div>
                                </div>
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from kegiatan order by idkegiatan ASC");
											$no=1;
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													<!-- <td></td> -->
                                                    <td><?php echo $no++?></td>
                                                    <td><img src="../kegiatan/<?php echo $p['foto'] ?>" width="100%"\></td>
													<td><?php echo $p['namakegiatan'] ?></td>
                                                    <td><?php echo $p['deskripsik'] ?></td>
													<td style="text-align:center">
                                                        ...
                                                        <a href="ubahkegiatan.php?idkegiatan=<?= $p['idkegiatan']; ?>" class="btn btn-warning btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;Ubah</a> |
                                                        <a href="hapuskegiatan.php?idkegiatan=<?= $p['idkegiatan']; ?>" class="btn btn-danger btn-sm" style="font-weight: 600;" onclick="return confirm('Apakah anda yakin ingin menghapus <?= $row['namakegiatan']; ?> ?');"><i class="bi bi-trash-fill"></i>&nbsp;Hapus</a>
                                                    </td>
												<?php 
											}
											?>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="form-group">
									...
									<input name="namakegiatan" type="text" class="form-control" required autofocus>
								</div>	
								<div class="form-group">
									<label for="uploadgambar" class="form-label">Foto Kegiatan<span style="color: red">*</span></label>
								...
								<div class="form-group">
									...
									<input name="deskripsik" type="text" class="form-control" required autofocus>
								</div>
								<input type="hidden" name="save" value="save">
							</div>
							<div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
								<input name="addkegiatan" type="submit" class="btn btn-primary" value="Tambah">
							</div>
						</form>
					</div>
				</div>
