...
$keahlian = query("SELECT * FROM keahlian WHERE idkeahlian = $idkeahlian")[0];

// Jika fungsi ubah lebih dari 0/data terubah, maka munculkan alert dibawah
if (isset($_POST['ubahkeahlian'])) {
    if (ubahkeahlian($_POST) > 0) {
        echo "<script>
                alert('Program Keahlian Berhasil Diubah!');
                document.location.href = 'keahlian.php';
            </script>";
    } else {
        // Jika fungsi ubah dibawah dari 0/data tidak terubah, maka munculkan alert dibawah
        echo "<script>
                alert('Program Keahlian Gagal Diubah!');
            </script>";
    }
}
...
<body>
            ...
            <div class="main-menu">
                ...
                <nav>
                        ...
                        <li><a href="index.php"><span>Beranda</span></a></li>
                            ...
                            <li><a href="guru.php"><span> Data Guru</span></a></li>
                            <li><a href="kegiatan.php"><span> Data Kegiatan</span></a></li>
                            <li><a href="fasilitas.php"><span>Dara Fasilitas</span></a></li>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="fw-bold text-uppercase"><i class="bi bi-pencil-square"></i>&nbsp;Ubah Program Keahlian</h3>
            </div>
            <hr>
        </div>
        <div class="row my-2">
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="idkeahlian" class="form-label">ID KEAHLIAN</label>
                        <input type="number" class="form-control w-50" id="idkeahlian" value="<?= $keahlian['idkeahlian']; ?>" name="idkeahlian" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="programkeahlian" class="form-label">Program Keahlian</label>
                        <input type="text" class="form-control w-50" id="programkeahlian" value="<?= $keahlian['programkeahlian']; ?>" name="programkeahlian" autocomplete="off" required>
                    </div>
                    
                    <hr>
                    <a href="keahlian.php" class="btn btn-secondary">Kembali</a>
                    <button type="submit" class="btn btn-warning" name="ubahkeahlian">Ubah</button>
                </form>
            </div>
        </div>
    </div>
