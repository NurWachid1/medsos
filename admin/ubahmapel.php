...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="fw-bold text-uppercase"><i class="bi bi-pencil-square"></i>&nbsp;Ubah Data Mata Pelajaran</h3>
            </div>
            <hr>
        </div>
        <div class="row my-2">
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="idmapel" class="form-label">ID MAPEL<span style="color: red">*</span></label>
                        <input type="number" class="form-control w-50" id="idmapel" value="<?= $mapel['idmapel']; ?>" name="idmapel" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="kodemp" class="form-label">Kode Mata Pelajaran<span style="color: red">*</span></label>
                        <input type="text" class="form-control w-50" id="kodemp" value="<?= $mapel['kodemp']; ?>" name="kodemp" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="namamapel" class="form-label">Mata Pelajaran<span style="color: red">*</span></label>
                        <input type="text" class="form-control w-50" id="namamapel" value="<?= $mapel['namamapel']; ?>" name="namamapel" autocomplete="off" required>
                    </div>
                    
                    <hr>
                    <a href="mapel.php" class="btn btn-secondary">Kembali</a>
                    <button type="submit" class="btn btn-warning" name="ubahmapel">Ubah</button>
                </form>
            </div>
        </div>
    </div>
