	...
	if(isset($_POST["addkatalog"])) {
		...
		//   if($ukuran_file <= 5000000){ 
			if(move_uploaded_file($tmp_file, $path)){ 
			  ...
			  $query = "insert into katalog (no_inventaris, inven_museum, idkategori, gambar, nama_benda, lokasi_asal, bahan, ukuran, deskripsi) values('$no_inventaris','$invent_museum','$idkategori','$nama_file','$nama_benda','$lokasi_asal','$bahanbenda','$ukuranbenda', '$deskripsi')";
			  $sql = mysqli_query($conn, $query); 
			  // Eksekusi/ Jalankan query dari variabel $query
			  
			  if($sql){ 
				
				echo "<br><meta http-equiv='refresh' content='15; URL=katalog.php'> You will be redirected to the form in 5 seconds";
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
							...
							<li class="active">
                                <a href="katalog.php" ><i class="ti-layout"></i><span>Kelola Katalog
                                    </span></a>
                                <ul class="collapse">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									...
									<button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-info col-md-2">Tambah Katalog</button>
                                </div>
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													<td><?php echo $no++?></td>
													<td><?php echo $p['no_inventaris'] ?></td>
													<td><?php echo $p['inven_museum'] ?></td>
													<td><img src="../<?php echo $p['gambar'] ?>" width="50%"\></td>
													<td><?php echo $p['nama_benda'] ?></td>
													<td><?php echo $p['nama_kategori'] ?></td>
													<td><?php echo $p['lokasi_asal'] ?></td>
													<td><?php echo $p['bahan'] ?></td>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="form-group">
									...
									<input name="no_inventaris" type="text" class="form-control" required autofocus>
								</div>
								<div class="form-group">
									<label>Inventaris Museum</label>
									<input name="inven_museum" type="text" class="form-control" required autofocus>
								</div>		
						<div class="form-group">
									<label>Nama Benda</label>
									<input name="nama_benda" type="text" class="form-control" required autofocus>
								</div>
								<div class="form-group">
									...
									?>
										<option value="<?php echo $d['idkategori'] ?>"><?php echo $d['nama_kategori'] ?></option>
										<?php
								}
								?>		
									</select>
								...
								<div class="form-group">
									...
									<input name="lokasi_asal" type="text" class="form-control" required>
								</div>
								<div class="form-group">
									<label>Bahan</label>
									<input name="bahan" type="text" class="form-control"  required>
								</div>
								<div class="form-group">
							...
							<div class="modal-footer">
								...
								<input name="addkatalog" type="submit" class="btn btn-primary" value="Tambah">
							</div>
						</form>
					</div>
				</div>
