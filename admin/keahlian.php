...
// require 'function.php';
	...
	if(isset($_POST['addkeahlian']))
	{
		$programkeahlian = $_POST['programkeahlian'];
			  
		$tambahprogram = mysqli_query($conn,"INSERT into keahlian values ('','$programkeahlian')");
		if ($tambahprogram){
		echo "<script>
        ...
        document.location.href = 'keahlian.php';
            ...
            alert('Program Keahlian Gagal Ditambahkan!');
        </script>";
		}
...
<head>
    ...
    <title>Kelola Program Keahlian</title>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-sm-flex justify-content-between align-items-center">
									<h2>Program Keahlian Sekolah</h2>
                                </div>
                                <div class="row my-2">
                                    <div class="col-md">
                                    <button style="margin-bottom:20px" data-toggle="modal" data-target="#myModal" class="btn btn-primary">Tambah Program</button>
                                    </div>
                                </div>
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from keahlian order by idkeahlian ASC");
											$no=1;
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													<!-- <td></td> -->
                                                    <td><?php echo $no++?></td>
													<td><?php echo $p['programkeahlian'] ?></td>>
													<td style="text-align:center">
                                                        ...
                                                        <a href="ubahkeahlian.php?idkeahlian=<?= $p['idkeahlian']; ?>" class="btn btn-warning btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;Ubah</a> |
                                                        <a href="hapuskeahlian.php?idkeahlian=<?= $p['idkeahlian']; ?>" class="btn btn-danger btn-sm" style="font-weight: 600;" onclick="return confirm('Apakah anda yakin ingin menghapus Program Keahlian <?= $row['programkeahlian']; ?> ?');"><i class="bi bi-trash-fill"></i>&nbsp;Hapus</a>
                                                    </td>
												<?php 
											}
											?>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h4 class="modal-title">Masukkan Data Program</h4>
						</div>
					<div class="modal-body">
						<form action="keahlian.php" method="post">
								<div class="form-group">
									<label>Program Keahlian</label>
									<input name="programkeahlian" type="text" class="form-control" placeholder="Masukkan Program Keahlian" required>
								</div>

							<div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">Batal</button>
								<input name="addkeahlian" type="submit" class="btn btn-primary" value="Tambah">
							</div>
						</form>
					</div>
				</div>
