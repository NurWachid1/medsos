...
<head>
    ...
    <title>Data Komentar | SMK PGRI 1 Bangkalan</title>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row my-2">
                                    <div class="col-md">
                                        <!-- <a href="exportkomentar.php" target="_blank" class="btn btn-success ms-1"><i class="bi bi-file-earmark-spreadsheet-fill"></i>&nbsp;Ekspor ke Excel</a> -->
                                    </div>
                                </div>
                                    <div class="data-tables datatable-dark">
										 <table id="dataTable3" class="display" style="width:100%"><thead class="thead-dark">
											...
											<?php 
											$brgs=mysqli_query($conn,"SELECT * from komentar order by idkomentar ASC");
											// $no=1;
											while($p=mysqli_fetch_array($brgs)){
												...
												<tr>
													...
													<td style="text-align: center">
                                                        ...
                                                        <!-- <a href="ubahkomen.php?nis=" class="btn btn-warning btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;Ubah</a> | -->
                                                        <a href="hapuskomen.php?idkomentar=<?= $p['idkomentar']; ?>" class="btn btn-danger btn-sm" style="font-weight: 600;" onclick="return confirm('Apakah anda yakin ingin menghapus komentar dari <?= $row['nama_user']; ?> ?');"><i class="bi bi-trash-fill"></i>&nbsp;Hapus</a>
                                                    </td>
												<?php 
											}
											?>
