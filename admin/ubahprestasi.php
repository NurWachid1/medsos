...
$prestasi = query("SELECT * FROM prestasi WHERE idprestasi = $idprestasi")[0];
...
<body>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="fw-bold text-uppercase"><i class="bi bi-pencil-square"></i>&nbsp;Ubah Data Prestasi</h3>
            </div>
            <hr>
        </div>
        <div class="row my-2">
            <div class="col-md">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="idprestasi" class="form-label">ID PRESTASI<span style="color: red">*</span></label>
                        <input type="number" class="form-control w-50" id="idprestasi" value="<?= $prestasi['idprestasi']; ?>" name="idprestasi" readonly>
                    </div>
                    <div class="mb-3">
                        <label for="prestasi" class="form-label">Prestasi<span style="color: red">*</span></label>
                        <input type="text" class="form-control w-50" id="prestasi" value="<?= $prestasi['prestasi']; ?>" name="prestasi" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="nama" class="form-label">Nama<span style="color: red">*</span></label>
                        <input type="text" class="form-control w-50" id="nama" value="<?= $prestasi['nama']; ?>" name="nama" autocomplete="off" required>
                    </div>
                    <div class="mb-3">
                        <label for="tahun" class="form-label">Tahun<span style="color: red">*</span></label>
                        <input type="text" class="form-control w-50" id="tahun" value="<?= $prestasi['tahun']; ?>" name="tahun" autocomplete="off" required>
                    </div>
                    
                    <hr>
                    <a href="prestasi.php" class="btn btn-secondary">Kembali</a>
                    <button type="submit" class="btn btn-warning" name="ubahprestasi">Ubah</button>
                </form>
            </div>
        </div>
    </div>
