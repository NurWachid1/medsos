                ...
                <div class="row d-flex align-items-center gy-4">
                  ...
                  <div class="col-md-5">
                    ...
                    <ol class="text-sm justify-content-start justify-content-lg-end mb-0 breadcrumb undefined">
                      <li class="breadcrumb-item"><a class="text-uppercase" href="#">Akademik</a></li>
                          ...
                          <div class="accordion-item mb-2">
                            ...
                            <div class="accordion-collapse collapse show" id="accordion2-collapseOne" aria-labelledby="accordion2-collapseOne" data-bs-parent="#accordion2">
                              <div class="accordion-body">
                                ...
                                Teknik sepeda motor (TSM) merupakan salah satu program keahlian yang berfokus pada perbaikan dan bisnis sepeda motor. Program keahlian ini telah berakreditasi "B"
                              </p>
                              <br>
                              <p> Struktur kurikulum yang berlaku pada program TSM adalah K13 dan Kurikulum Merdeka. Struktur kurikulum yang digunakan dapat diunduh pada daftar berikut.
                              </p>
                              <ol>
                                <li><a href="strukturkurikulum/Struktur_Kurikulum_Merdeka.pdf"><i class="bx bxs-file"></i>Struktur Kurikulum Merdeka</a></li>
                                <li><a href="strukturkurikulum/Struktur_K13_TSM.pdf"><i class="bx bxs-file"></i>Struktur Kurikulum K13 TSM</a></li>
                              </ol>
                              </div>
                            </div>
                          </div>
                  ...
                  <div class="accordion mb-5" id="accordion3">
                          <div class="accordion-item mb-2">
                            ...
                            <div class="accordion-body">
                                ...
                                Teknik komputer dan jaringan (TKJ) merupakan salah satu program keahlian yang berfokus pada komputer dan jaringan. Program keahlian ini telah berakreditasi "B"
                              </p><br>
                              <p> Struktur kurikulum yang berlaku pada program TKJ adalah K13 dan Kurikulum Merdeka. Struktur kurikulum yang digunakan dapat diunduh pada daftar berikut.
                              </p>
                              <ol>
                                <li><a href="strukturkurikulum/Struktur_Kurikulum_Merdeka.pdf"><i class="bx bxs-file"></i>Struktur Kurikulum Merdeka</a></li>
                                <li><a href="strukturkurikulum/Struktur_K13_TKJ.pdf"><i class="bx bxs-file"></i>Struktur Kurikulum K13 TKJ</a></li>
                              </ol>
                              </div>
                            </div>
                          </div>
