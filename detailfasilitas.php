...
$sql = "SELECT*from fasilitas where idfasilitas='$idfasilitas'";
  ...
  <section class="bg-pentagon py-4">
              <div class="container py-3">
                <div class="row d-flex align-items-center gy-4">
                  <div class="col-md-7">
                    <h1 class="h2 mb-0 text-uppercase"><?php echo $data['namafasilitas'] ?></h1>
                  </div>
                  <div class="col-md-5">
                    <!-- Breadcrumb-->
                    <ol class="text-sm justify-content-start justify-content-lg-end mb-0 breadcrumb undefined">
                      <li class="breadcrumb-item"><a class="text-uppercase" href="#">Profil</a></li>
                      <li class="breadcrumb-item text-uppercase active">Fasilitas</li>
                    </ol>
                  </div>
                </div>
              </div>
              ...
              <div class="accordion-item mb-2">
                        ...
                        <div class="accordion-collapse collapse show" id="accordion1-collapseOne" aria-labelledby="accordion1-collapseOne" data-bs-parent="#accordion1">
                          <div class="accordion-body">
                            ...
                            <div class="row">
                              <div class="col-md-4"><img class="img-fluid" src=" fasilitas/<?php echo $data['foto'] ?>" alt="Foto Fasilitas">
                              </div>
                              <div class="col-md-8">
                              <p >Fasilitas       : <?php echo $data['namafasilitas'] ?>
                                <br>Jumlah Ruangan  : <?php echo $data['jumlah'] ?>
                                <br>Deskripsi  : <?php echo $data['deskripsi'] ?>
                              </p>  
                            </div>
                            </div>
                          </div>
