  ...
  <section class="bg-pentagon py-4">
              <div class="container py-3">
                <div class="row d-flex align-items-center gy-4">
                  <div class="col-md-7">
                    <h1 class="h2 mb-0 text-uppercase">Detail Berita</h1>
                  </div>
                  <div class="col-md-5">
                    <!-- Breadcrumb-->
                    <ol class="text-sm justify-content-start justify-content-lg-end mb-0 breadcrumb undefined">
                      ...
                      <li class="breadcrumb-item text-uppercase active">Berita</li>
                    </ol>
                  </div>
                </div>
              </div>
        ...
        <div class="container">
          <div class="row g-5">
            ...
            <div class="col-lg-12">
                          ...
                          <!-- <header class="mb-5"> -->
            <h2 class="lined lined-center text-uppercase mb-4"><?php echo $data['judulberita'] ?></h2>
            <!-- <p class="lead text-center">SMK PGRI 1 BANGKALAN</p> -->
          <!-- </header> -->
                            
                              <p><?php echo $data['berita'] ?>
                              </p> 
                              <a href="berita/<?php echo $data['fileberita'] ?>" style="text-align:center"><i class="bx bxs-file"></i>Unduh</a>
                              <!-- <iframe width="400" height="700" src="berita/<?php echo $data['fileberita'] ?>"></iframe> -->
