  ...
  <section class="bg-pentagon py-4">
              <div class="container py-3">
                <div class="row d-flex align-items-center gy-4">
                  <div class="col-md-7">
                    <h1 class="h2 mb-0 text-uppercase">Detail Kegiatan</h1>
                  </div>
                  <div class="col-md-5">
                    <!-- Breadcrumb-->
      ...
      <section class="py-5">
        <div class="container">
          <div class="row g-2">
            ...
            <h2 class="lined lined-center text-uppercase mb-4" ><?php echo $data['namakegiatan'] ?></h2>
                            
                                <img class="img-fluid" src=" kegiatan/<?php echo $data['foto'] ?>" alt="Foto Kegiatan" style="margin-left:auto; margin-right:auto; display:block; width:400px; heigth:250px">
                             
                             <br>
                               
                                <p style="margin-left:auto; margin-right:auto; display:block;"><?php echo $data['deskripsik'] ?></p>
