	...
	<div>
			<div class="col-lg-12">
				<h1 class="page-header">Data Fasilitas</h1>
				            		...
				            		<?php 
				            		$cari = $conn->query("SELECT max(idfasilitas) from fasilitas");
...
<?php
                    if(isset($_POST['tambah'])){
                        ...
                        $q="INSERT INTO fasilitas(idfasilitas,foto,namafasilitas) VALUES('$idfasilitas','$nama_file','$namafasilitas')";
                        mysqli_query($conn,$q);
                        ?>
                        <script type="text/javascript">alert("Data Berhasil Ditambahkan");document.location.href="?page=fasilitas";</script>
                    <?php
                    }
                    ?>
</div>
