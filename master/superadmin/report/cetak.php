...
$id_srt =@$_GET['id_srt'];
$q= mysqli_query($koneksi,"SELECT tb_user. * , tb_surat. * FROM tb_surat INNER JOIN tb_user ON tb_user.id_user = tb_surat.id_user where id_srt='$id_srt'");
...
<img src="css/logo/jt.png" style=" height:140px; margin-left: 30px;">
</div>
...
<img src="css/logo/smk.png" style="height:140px;">
</div>
</div>
<div class="row">
<center>
...
<tr>
<td colspan="2" style="padding-left: 80px; padding-top: 20px;">Waktu : <?php echo $d['hari'];?>  </td>
</tr>
<tr>
<td colspan="2" style="padding-left: 80px; padding-top: 20px;">Waktu : <?php echo $d['waktu'];?>  </td>
</tr>
<tr>
<td colspan="2" style="padding-left: 80px; padding-top: 20px;">Tanggal : <?php echo $d['tgl'];?> </td>
</tr>
<tr>
<td colspan="2" style="padding-left: 80px; padding-top: 20px;">Tempat :  <?php echo $d['tempat'];?> </td>
</tr>
<tr>
<td colspan="2" style="padding-left: 80px; padding-top: 20px;">Aacara : <?php echo $d['subjek_srt']; ?></td>
</tr>
<tr>
