...
<div class="col-md-6">
	<div>
			<div class="col-lg-12">
				<h1 class="page-header">Data Proyek PIPAS</h1>
			</div>
	</div>

				            		<?php 
				            		$cari = $conn->query("SELECT max(idpipas) from pipas");
										...
										<!-- <div class="form-group" >
							           	...
							           	<div class="form-group" >
							               	<div class="input-field">
							                   	...
							                   	<input type="text" class="form-control" name="judulpipas" required>
							               	</div>
							             </div>
							              <div class="form-group" >
							               	<div class="input-field">
							               		<label >Deskripsi<span style="color:red"> *<span></label>
							                   	<textarea name="deskripsipipas" minlength="10"  rows="10" type="text" class="form-control" required autofocus></textarea>
							               	</div>
							               </div>
...
<?php
                    if(isset($_POST['tambah'])){
                        $idpipas= @$_POST['idpipas'];
                        $judulpipas = @$_POST['judulpipas'];
                        $deskripsipipas= @$_POST['deskripsipipas'];
                        $lokasi_file = @$_FILES['gambar']['tmp_name'];
                        $nama_file = @$_FILES['gambar']['name'];
                        $folder = "karya/pipas/$nama_file";
                        // $level = @$_POST['level'];
                        move_uploaded_file($lokasi_file,"$folder");
                        $q="INSERT INTO pipas(idpipas,foto_pipas,judulpipas,deskripsi_pipas) VALUES('$idpipas','$nama_file', '$judulpipas', '$deskripsipipas')";
                        mysqli_query($conn,$q);
                        ?>
                        <script type="text/javascript">alert("Data Berhasil Ditambahkan");document.location.href="?page=pipas";</script>
                    <?php
                    }
                    ?>
</div>
