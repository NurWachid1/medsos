	...
	<div>
			<div class="col-lg-12">
				<h1 class="page-header">Data Mata Pelajaran</h1>
				            		...
				            		<?php 
				            		$cari = $conn->query("SELECT max(idmapel) from mapel");
										...
										<!-- <div class="form-group" >
							           	...
							           	<div class="form-group" >
							               	<div class="input-field">
							                   	...
							                   	<input type="text" class="form-control" name="kodemp" required>
							               	</div>
							             </div>
							              <div class="form-group" >
							               	<div class="input-field">
...
<?php
                    if(isset($_POST['tambah'])){
                        ...
                        $q="INSERT INTO mapel(idmapel,kodemp,namamapel) VALUES('$idmapel','$kodemp', '$namamapel')";
                        mysqli_query($conn,$q);
                        ?>
                        <script type="text/javascript">alert("Data Berhasil Ditambahkan");document.location.href="?page=mapel";</script>
                    <?php
                    }
                    ?>
</div>
