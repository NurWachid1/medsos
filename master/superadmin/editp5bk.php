										...
										<!-- <div class="form-group" >
							           	...
							           	<div class="form-group" >
							               	<div class="input-field">
							                   	...
							                   	<input type="text" class="form-control" name="judulp5bk" value="<?php echo $data['judulp']; ?>" required>
							               	</div>
							             </div>
							              <div class="form-group" >
							               	<div class="input-field">
							               		<label >Deskripsi<span style="color:red"> *<span></label>
												   <textarea name="deskripsip5bk" minlength="10"  rows="10" type="text" class="form-control"  required autofocus>
												   <?php echo $data['deskripsip']; ?>
												   </textarea>
							                   	<!-- <input type="text" class="form-control" name="deskripsip5bk" value="<?php echo $data['deskripsip']; ?>" required> -->
							               	</div>
							               </div>
							               <div class="form-group">
