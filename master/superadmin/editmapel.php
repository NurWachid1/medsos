										...
										<!-- <div class="form-group" >
							           	...
							           	<div class="form-group" >
							               	<div class="input-field">
							                   	...
							                   	<input type="text" class="form-control" name="kodemp" value="<?php echo $data['kodemp']; ?>" required>
							               	</div>
							             </div>
							               <div class="form-group" >
							               	<div class="input-field">
							               		<label >Mata Pelajaran<span style="color:red"> *<span></label>
							                   	<input type="text" class="form-control" name="mapel" value="<?php echo $data['namamapel']; ?>" required>
							               	</div>
							   				</div>
