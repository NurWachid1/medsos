...
<div class="col-md-6">
		...
		<div class="row" style="float: right; margin-right: 15px;">
				            <div>
						       	...
						       	<a href="?page=user&act=lihat" class="btn btn-danger z-depth-3">Batal</a>
				            </div>
				        </div>
</div>
</div>
                        ...
                        if($nama_file != ""){
                            ...
                            if($update){
                                ?>
                                              ...
                                              <script type="text/javascript">alert("Data Berhasil Diubah");document.location.href="?page=user&act=lihat";</script>
                                <?php
                            } else {
                                ?>
