										...
										<!-- <div class="form-group" >
							           	...
							           	<div class="form-group" >
							               	<div class="input-field">
							                   	...
							                   	<input type="text" class="form-control" name="judulpipas" value="<?php echo $data['judulpipas']; ?>">
							               	</div>
							             </div>
							               <div class="form-group" >
							               	<div class="input-field">
							               		<label >Deskripsi<span style="color:red"> *<span></label>
							                   	<input type="text" class="form-control" name="deskripsipipas" value="<?php echo $data['deskripsi_pipas']; ?>">
							               	</div>
							   				</div>
							               <div class="form-group">
