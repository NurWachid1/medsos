				...
				<h1 class="page-header">Data Anda!</h1>
                              ...
                              <label class="control-label">Gambar</label>
                                    <input type="file" class="form-control" name="gambar"  >
                                     <span><?php echo $data['gambar'];?></span>
                      ...
                      if($file_size <= 1000000){
                        if($nama_file != ""){
                            ...
                            if(is_file("img/".$data['gambar'])) // Jika foto ada
                                 unlink("img/".$data['gambar']); // Hapus file  sebelumnya yang ada di folder images
    
                            $update = $conn->query("UPDATE tb_user SET username='$username', password='$password',
                                                    fullname='$fullname', email='$email',alamat='$alamat',
                                                    phone='$phone', gambar='$nama_file' WHERE id_user='$id_user' ");
                            if($update){
                                ?>
                              
                                              <script type="text/javascript">alert("Edit File berhasil");document.location.href="?page=user";</script>
                                <?php
                            } else {
                                ?>
                            ...
                            if($update){
                                ?>
                                              ...
                                              <script type="text/javascript">alert("Edit data berhasil");document.location.href="?page=user";</script>
                               <?php
                     } else {
                                              ?>
