...
$folder = "file/$nama_file";
 if($file_size <= 1000000){
    ...
    // Proses ubah data ke Database
                  ...
                  $update = $conn->query("UPDATE tb_surat SET pengirim_srt='$pengirim_srt', kode_srt='$kode_srt', distansi_srt='$distansi_srt', tujuan_srt='$tujuan_srt',subjek_srt='$subjek_srt', deskripsi_srt='$deskripsi_srt', file_srt='$nama_file' WHERE id_srt='$id_srt' ");
                                          if($update){
                                              ?>
                                              
                                              <script type="text/javascript">alert("Edit File berhasil");document.location.href="?p=suratm";</script>
                                              <?php
                                          } else {
                                              ?>
                                          ...
                                          $update = $conn->query("UPDATE tb_surat SET pengirim_srt='$pengirim_srt', kode_srt='$kode_srt', distansi_srt='$distansi_srt', tujuan_srt='$tujuan_srt',subjek_srt='$subjek_srt',deskripsi_srt='$deskripsi_srt'  WHERE id_srt='$id_srt' ");
                                          if($update){
                                              ?>
                                              
                                                 <script type="text/javascript">alert("Edit data berhasil");document.location.href="?page=surat";</script>
                                              <?php
                                          } else {
                                              ?>
