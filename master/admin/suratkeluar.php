...
<div class="panel-body">
    <table class="table">
                         ...
                         <tbody>
                            <?php
  $qjumlah=mysqli_query($conn,"SELECT * FROM tb_surat where id_tipe_srt='T002' ");
  ...
  ?>
    ...
    //paging
    $no=1+$posisi;
                            $surat_klr = $conn->query("SELECT tb_user. * , tb_surat. * FROM tb_surat INNER JOIN tb_user ON tb_user.id_user = tb_surat.id_user where id_tipe_srt='T002'  limit $posisi,$batas ");
                            ...
                            <tr>
                                ...
                                <td style="width: 300px;">
                                    ...
                                    <b>File :</b><a href="file/<?php echo $data['file_srt']; ?>"><?php echo $data['file_srt']; ?></a>
                                    </td>
                                <td><?php echo $data['pengirim_srt']; ?><legend></legend>
                                    <?php echo $data['tujuan_srt'] ?>
                                </td>
                                <td>
                                  <a href="?page=surat&act=editsk&id_srt=<?php echo $data['id_srt']; ?>" class="btn btn-primary  z-depth-4"><i class="fa fa-pencil"></i> Edit</a>
