  ...
  <section class="bg-pentagon py-4">
              <div class="container py-3">
                <div class="row d-flex align-items-center gy-4">
                  <div class="col-md-7">
                    <h1 class="h2 mb-0 text-uppercase">DETAIL GURU</h1>
                  </div>
                  <div class="col-md-5">
                    <!-- Breadcrumb-->
                    <ol class="text-sm justify-content-start justify-content-lg-end mb-0 breadcrumb undefined">
                      ...
                      <li class="breadcrumb-item text-uppercase active">DETAIL GURU</li>
                    </ol>
                  </div>
                </div>
              </div>
        ...
        <div class="container">
          <div class="row g-5">
            ...
            <div class="col-lg-12">
                          ...
                          <!-- <header class="mb-5"> -->
            <h2 class="lined lined-center text-uppercase mb-4" ><?php echo $data['keterangan'] ?></h2>
            <!-- <p class="lead text-center">SMK PGRI 1 BANGKALAN</p> -->
          <!-- </header> -->
                              <img class="img-fluid" src=" guru/<?php echo $data['foto'] ?>" alt="Foto Guru" style="margin-left:auto; margin-right:auto; display:block; width:125px; height:175px">
                      ...
                      <tbody style="margin-left:450px; margin-right:auto; display:block;">
                        ...
                        <td>Alamat Domisili</td>
                          <td>:</td>
                              ...
                              <!-- <p style="margin-top:55px">NIP       : <?php echo $data['nip'] ?>
