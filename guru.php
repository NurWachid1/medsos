  ...
  <section class="bg-pentagon py-4">
              <div class="container py-3">
                <div class="row d-flex align-items-center gy-4">
                  <div class="col-md-7">
                    <h1 class="h2 mb-0 text-uppercase">Guru & Tenaga Kependidikan</h1>
                  </div>
                  <div class="col-md-5">
                    <!-- Breadcrumb-->
        ...
        <div class="row gy-4">
            <?php
        $brgs=mysqli_query($conn,"SELECT * from guru order by idguru ASC");
					while($p=mysqli_fetch_array($brgs)){
            ?>
        <div class="col-lg-3 col-md-3 col-sm-6 text-center"><a href="detail-guru.php?idguru=<?= $p['idguru']; ?>"><img class="avatar avatar-xl p-1 mb-4" src="guru/<?php echo $p['foto'] ?>" alt="Foto Guru"></a>
              <h5 class="mb-1 "><a class="text-reset" href="detail-guru.php?idguru=<?= $p['idguru']; ?>"><?php echo $p['namaguru'] ?></a></h5>
              <p class="text-muted small text-uppercase"><?php echo $p['keterangan'] ?></p>
            </div>
            <?php }
            ?>
            </div>
