  ...
  <section class="bg-pentagon py-4">
              <div class="container py-3">
                <div class="row d-flex align-items-center gy-4">
                  <div class="col-md-7">
                    <h1 class="h2 mb-0 text-uppercase">Karya P5BK<?php echo $data['idp5bk'] ?></h1>
                  </div>
                  <div class="col-md-5">
                    <!-- Breadcrumb-->
              ...
              <div class="accordion-item mb-2">
                        ...
                        <div class="accordion-collapse collapse show" id="accordion1-collapseOne" aria-labelledby="accordion1-collapseOne" data-bs-parent="#accordion1">
                          <div class="accordion-body">
                            ...
                            <div class="row">
                              <div class="col-md-4"><img class="img-fluid" src=" master/karya/p5bk/<?php echo $data['fotop'] ?>" alt="Foto Fasilitas">
                              </div>
                              <div class="col-md-8">
                              <p >Judul Karya       : <?php echo $data['judulp'] ?>
                                <br>Deskripsi  : <?php echo $data['deskripsip'] ?>
                              </p>  
                            </div>
                            </div>
                          </div>
